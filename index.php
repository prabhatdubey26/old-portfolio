<?php include('header.php'); ?>
        ...
        <div class="header-intro theme-bg-primary text-white py-5">
	        <div class="container">
		        <div class="profile-teaser media flex-column flex-md-row">
				    <img class="profile-image mb-3 mb-md-0 mr-md-5 ml-md-0 rounded mx-auto" src="assets/images/prabhat.jpg" alt="">
					<div class="media-body text-center text-md-left">
					<div class="lead">Hello, my name is</div>
					<h2 class="mt-0 display-4 font-weight-bold">Prabhat Dubey</h2>
					<div class="bio mb-3">I'm a full-stack developer developer with industry experience building websites and web applications. I specialize in Python and have professional experience working with Python and PHP. I also have experience working with HTML, CSS, jQUERY, AJAX, Bootstrap and codeigniter, LARAVEL, Django. I have 2 year experience in Rest Full API. Want to know how I may help your project? Check out my project <a class="link-on-bg" href="projects">case studies</a> and <a class="link-on-bg" href="resume">resume</a>.
					</div><!--//bio-->
    ...
    <section class="skills-section section py-5">
        <div class="container">
	        ...
	        <div class="section-intro mx-auto text-center mb-5 text-secondary">I have more than 2 years' experience building rich web applications for clients all over the world. Below is a quick overview of my main technical skill sets and tools I use. Want to find out more about my experience? <a href="resume">Check out my online resume</a>.</div>
